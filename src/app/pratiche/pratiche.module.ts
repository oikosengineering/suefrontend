...
@NgModule({
  declarations: [ModuloComponent, DynamicFormDirective, DettagliPraticaComponent, DetailsPraticheDirective, OccupazioneEdileComponent, OccupazioneSuoloPubblicoComponent],
